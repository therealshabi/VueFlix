<template>
  <div :style='{backgroundImage: movie.largeImgSrc}' :class="{'films-bg': true, favorite: movie.favorite}"> 
    <div class="header">
        ...
        <div style="color:red;margin: auto 10px;font-weight:bold;cursor: pointer;">VUEFLIX</div>
    </div>
    ...
    <div style="text-align:left;margin: 5px 40px; line-height:1.2; width:45%">
        ...
        <div style="display:flex">
            <div style="display:flex; cursor:pointer; background-color:#DE0000;color:white; border-radius: 500px; border:none; width:fit-content; padding:5px 12px 5px 16px ">
