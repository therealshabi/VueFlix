<template>
  <div class="col">
      ...
      <films class= "header" v-else :movie="movies[movieId]" @toggleFavorite="toggleFavorite" @goHome = "movieId=''"></films>
      <section id="footer">
          <div v-for="movie in movies" v-on:click="movieId=movie.id" style="flex:20%;padding:0px 10px; position: relative">
