    ...
    <section id="footer">
      <div style="display: flex;">
        ...
        <div
          ...
          v-bind:key="movie.id"
          v-on:click="handleMovieClick(movie.id)"
        ...
        >
          ...
          <i
            ...
            style="position:absolute; right:10%; top: 2px; color:yellow; font-size:18px"
          >check_circle</i>
        </div>
      </div>
    </section>
...
export default {
  ...
  data: () => ({
    ...
    loading: true,
    tagline:
      'What\'s special? Well, Please Dive in to FLIX <i class=\'em-svg em-wink\'></i>',
    movies: {}
  }),
